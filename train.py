...
#os.chdir(r"C:\Users\your\pth\here")
...
def load_dataset(path, split=0.2):
    ...
    if len(X) == 0 or len(Y) == 0:
        raise ValueError("No images or masks found. Check the dataset_path and directory structure.")
...
if __name__ == "__main__":
    ...
    csv_path = os.path.join("files", "memory.txt")

    """ Dataset """
    dataset_path = "C:\\your\\path\\here"
